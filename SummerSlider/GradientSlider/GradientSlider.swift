...
@IBDesignable public class GradientSlider: UISlider {
    ...
    @IBInspectable var sliderHeight: CGFloat = 20.0 { // used 20 as a default but can be changed from Interface Builder
            didSet {
                setup()
            }
        }
    ...
    @IBInspectable var sliderBackgroundColor: UIColor? {
        ...
        func setup() {
            ...
            let maxTrackColor = sliderBackgroundColor// default color can be changed from Interface Builder
